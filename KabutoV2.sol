...
function WithdrawERC20(address _to, uint256 _withdrawalamount, address _tokencontract) external onlyOwner {
...
function WithdrawETC(address payable _recipient) external onlyOwner {
